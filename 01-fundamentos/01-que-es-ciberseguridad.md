...
La **ciberseguridad** es la disciplina encargada de proteger sistemas informáticos, redes, dispositivos, aplicaciones y datos frente a amenazas digitales.

Incluye el uso de tecnologías, políticas, controles, procedimientos y buenas prácticas orientadas a prevenir incidentes de seguridad y reducir riesgos.

Su finalidad es garantizar que la información y los servicios digitales permanezcan seguros, disponibles y confiables.

---

## Importancia de la Ciberseguridad

En la actualidad, personas, empresas y gobiernos dependen de infraestructuras digitales para operar diariamente.
...
Un usuario recibe un correo falso del banco solicitando verificar su cuenta.
...
## Importancia en Ingeniería Informática
...
La ciberseguridad es un componente esencial del mundo digital. Su misión es proteger la información, los sistemas y los servicios frente a amenazas constantes.

Comprender sus fundamentos es el primer paso para convertirse en un profesional capaz de diseñar, defender y auditar entornos tecnológicos seguros.
